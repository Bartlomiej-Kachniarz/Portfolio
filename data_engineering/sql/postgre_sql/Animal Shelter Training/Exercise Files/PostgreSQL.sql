...
CREATE TABLE animals(
    species varchar(10) NOT NULL REFERENCES reference.species(species) ON UPDATE CASCADE,
    name varchar(20) NOT NULL,
    primary_color varchar(10) NOT NULL REFERENCES reference.colors(color) ON UPDATE CASCADE,
...
INSERT INTO animals(name, species, primary_color, implant_chip_id, breed, gender, birth_date, pattern, admission_date)
    VALUES ('Abby', 'Dog', 'Black', 'fdfdb6fe-3347-4e80-8c8a-2e3235c6d1de', NULL, 'F', CAST('1999-02-19' AS date), 'Tricolor', CAST('2016-07-19' AS date)),
...
INSERT INTO persons(email, first_name, last_name, birth_date, address, state, city, zip_code)
    VALUES ('adam.brown@gmail.com', 'Adam', 'Brown', CAST('1984-12-22' AS date), '41 Hill', 'California', 'Norwalk', '90650'),
...
CREATE TABLE staff(
    email varchar(100) NOT NULL PRIMARY KEY REFERENCES persons(email) ON UPDATE CASCADE,
    hire_date date NOT NULL
);

INSERT INTO staff(email, hire_date)
    VALUES ('ashley.flores@animalshelter.com', CAST('2016-01-01' AS date)),
...
CREATE TABLE staff_assignments(
    role VARCHAR(20) NOT NULL REFERENCES staff_roles(ROLE) ON UPDATE CASCADE,
...
INSERT INTO staff_assignments(email, ROLE, assigned)
    VALUES ('ashley.flores@animalshelter.com', 'Veterinarian', CAST('2016-01-01' AS date)),
...
CREATE TABLE adoptions(
    ...
    FOREIGN KEY (species, name) REFERENCES animals(species, name) ON UPDATE CASCADE
);

INSERT INTO adoptions(name, species, adopter_email, adoption_date, adoption_fee)
    VALUES ('Abby', 'Dog', 'patrick.hughes@animalshelter.com', CAST('2018-08-30' AS date), 58),
...
INSERT INTO vaccinations(name, species, vaccination_time, vaccine, batch, comments, email)
    VALUES ('Abby', 'Dog', CAST('2017-04-19T09:01:00.0000000' AS timestamp), 'Distemper Virus', 'N-178784096', NULL, 'ashley.flores@animalshelter.com'),
...
CREATE TABLE routine_checkups(
    species varchar(10) NOT NULL,
    name varchar(20) NOT NULL,
    CONSTRAINT FK_routine_checkups__animals FOREIGN KEY (species, name) REFERENCES animals(species, name) ON UPDATE CASCADE,
    ...
    comments varchar(500) NULL,
    performed_by varchar(100) NOT NULL REFERENCES staff(email) ON UPDATE CASCADE,
...
INSERT INTO routine_checkups(species, name, checkup_time, temperature, heart_rate, respiration, weight, comments, performed_by)
    VALUES ('Cat', 'Archie', CAST('2016-10-13T08:43:00' AS timestamp), 101.8, 175, 27, 9.3, NULL, 'ashley.flores@animalshelter.com'),
